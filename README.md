...
-   有料の Google 翻訳 API キーは必要はありません。Python の**deep-translator**による無料の翻訳です。そのため、翻訳の品質は Google 翻訳の結果に依存します。
...
## deep-translator の制限について

deep-translator は Google 翻訳などの無料翻訳サービスを利用するライブラリです。

Google 翻訳 API には利用制限があります。大量のリクエストを短時間に送信すると、
